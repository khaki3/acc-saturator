...
nvhpc_sat=extract("nvhpc-nosat.log")[7:]
gcc=extract("gcc.log")[7:]
gcc_sat=extract("gcc-nosat.log")[7:]
clang=extract("clang.log")
clang_sat=extract("clang-nosat.log")
...
plt.savefig('spec-omp-cse+bulk.pdf', bbox_inches='tight', pad_inches=0)
