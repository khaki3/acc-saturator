...
nvhpc_sat=extract("nvhpc-nobulk.log")[7:]
gcc=extract("gcc.log")[7:]
gcc_sat=extract("gcc-nobulk.log")[7:]
clang=extract("clang.log")
clang_sat=extract("clang-nobulk.log")
...
plt.savefig('spec-omp-cse+sat.pdf', bbox_inches='tight', pad_inches=0)
