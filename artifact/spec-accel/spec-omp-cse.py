...
nvhpc_sat=extract("nvhpc-cse.log")[7:]
gcc=extract("gcc.log")[7:]
gcc_sat=extract("gcc-cse.log")[7:]
clang=extract("clang.log")
clang_sat=extract("clang-cse.log")
...
plt.savefig('spec-omp-cse.pdf', bbox_inches='tight', pad_inches=0)
