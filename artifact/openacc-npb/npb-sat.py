...
nvhpc=extract("nvhpc.log")
nvhpc_sat=extract("nvhpc-sat.log")
gcc=extract("gcc.log")
gcc_sat=extract("gcc-sat.log")
...
for bars in ax.containers:
    ...
    for rect in bars:
        ...
        label = '%.2fx' % height
        height = height if height < 2.2 else 2.2
...
plt.savefig('npb-accsat.pdf', bbox_inches='tight')
